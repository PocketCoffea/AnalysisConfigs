...
cfg = Configurator(
    ...
    categories = {
        ...
        # Requesting a reconstructed electron of 20 GeV
        "semilep_recoele20": [get_nObj_min(1, 20., coll="Electron")],
        "semilep_recoele20_Ele28" : [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["Ele28"])],
        "semilep_recoele20_Ele30" : [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["Ele30"])],
        "semilep_recoele20_Ele32" : [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["Ele32"])],
        "semilep_recoele20_tripleB_Ele30": [ get_nObj_min(1, 20., coll="Electron"),
                                      get_HLTsel(["TripleBTag","Ele30"])] ,
        "semilep_recoele20_doubleB_tighter_Ele30": [ get_nObj_min(1, 20., coll="Electron"),
                                          get_HLTsel(["Jet4_btag2_tighter","Ele30"])] ,
        "semilep_recoele20_doubleB_looser_Ele30": [ get_nObj_min(1, 20., coll="Electron"),
                                         get_HLTsel(["Jet4_btag2_looser","Ele30"])],
        "semilep_recoele20_tripleB": [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["TripleBTag"])] ,
        "semilep_recoele20_doubleB_tighter": [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["Jet4_btag2_tighter"])] ,
        "semilep_recoele20_doubleB_looser": [ get_nObj_min(1, 20., coll="Electron"), get_HLTsel(["Jet4_btag2_looser"])],
