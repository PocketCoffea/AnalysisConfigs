...
from custom_weights import SF_top_pt, SF_ttlf_calib_with_ttcc_variations
...
cfg = Configurator(
    ...
    weights_classes = common_weights + [SF_ele_trigger, SF_top_pt, SF_ttlf_calib_with_ttcc_variations],
    weights= {
        "common": {
            "inclusive": [
                "genWeight", "lumi","XS",
                ...
                "sf_ttlf_calib_with_ttcc_variations"
            ],
        },
    },
    variations = {
