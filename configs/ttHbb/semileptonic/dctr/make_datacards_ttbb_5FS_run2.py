...
for year in ["2016_PreVFP", "2016_PostVFP", "2017", "2018"]:
    ...
    # DISCLAIMER: with this script we want to produce pseudodata using the ttbb 5FS sample instead of the ttbb 4FS sample
    # We consider as data samples all MC samples except for ttbb 4FS, that is replaced by the alternative ttbb 5FS sample
    samples_data = [
        "ttHTobb",
