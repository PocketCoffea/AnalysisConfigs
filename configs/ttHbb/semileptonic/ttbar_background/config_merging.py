...
cfg = Configurator(
    ...
    variables = {
        ...
        **count_hist(name="nGenJets", coll="GenJetGood", bins=14, start=0, stop=14, exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        ...
        **jet_hists(coll="GenJetGood", pos=0, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(coll="GenJetGood", pos=1, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(coll="GenJetGood", pos=2, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(coll="GenJetGood", pos=3, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(coll="GenJetGood", pos=4, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(name="bgenjet",coll="BGenJetGood", pos=0, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
        **jet_hists(name="bgenjet",coll="BGenJetGood", pos=1, fields=["pt", "eta", "phi"], exclude_samples=["DATA_SingleEle", "DATA_SingleMuon"]),
