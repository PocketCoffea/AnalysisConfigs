...
class ControlRegionsProcessor(SpanetInferenceProcessor):
    ...
    def process_extra_after_presel(self, variation) -> ak.Array:
        ...
        if "tthbb_transformed" not in self.events.spanet_output.fields:
            ...
            raise Exception("tthbb_transformed already exists in spanet_output. Please redefine this workflow to avoid overwriting it.")
