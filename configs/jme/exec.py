...
if eta_bins:
    ...
    for i in range(len(eta_bins) - 1):
        ...
        command1 = f'tmux new-session -d -s {eta_bin_min}to{eta_bin_max} && tmux send-keys "export ETA_MIN={eta_bin_min}" "C-m" "export ETA_MAX={eta_bin_max}" "C-m" "echo $ETA_BIN_MIN" "C-m" "echo $ETA_BIN_MAX" "C-m"'
        command2 = f'tmux send-keys "pocket_coffea" "C-m" "time runner.py --cfg jme_config.py --full -o out_separate_eta_bin/eta{eta_bin_min}to{eta_bin_max} -lf 1 -lc 1" "C-m"'
