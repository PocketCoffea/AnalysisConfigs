...
main_dir = args.dir
median_dir = f"{main_dir}/median_plots_unbinned" if args.unbinned else f"{main_dir}/median_plots_binned"
...
for i in range(len(correct_eta_bins) - 1):
    ...
    ax.set_ylabel("Median (Response) unbinned" if args.unbinned else "Median (Response) binned")
    # log x scale
    ax.set_xscale("log")
